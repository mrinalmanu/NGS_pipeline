...
docker run --name $container_name -v /var/run/docker.sock:/var/run/docker.sock -v $input_folder/:$input_folder/ -v $output_folder:/home/output/ -v $reference_folder:/home/Reference/ -it $docker_image
